                      ...
                      for (var i = 0; i < settings.columns.editable.length; i++) {
                          ...
                          $td.each(function() {
                              ...
                              // Check if exists the third parameter of editable array.
                                                          // [ars] Тут тупая проверка на !== 'undefined' :(
                              ...
                              // [ars] Тут крутышный switch :)
                              // https://github.com/markcell/jquery-tabledit/pull/38/files
                              var input = "";
          ...
          $table.on('keyup', function(event) {
              ...
              switch (event.keyCode) {
                  case 9:  // Tab.
                      ...
                      break;
                  case 13: // Enter. Ctlr+Enter для TEXTAREA.
                      if ((event.ctrlKey && event.target.tagName == "TEXTAREA") || event.target.tagName != "TEXTAREA" ) {
                          Edit.submit($td);
                        //   location.reload();
                      }
                      break;
